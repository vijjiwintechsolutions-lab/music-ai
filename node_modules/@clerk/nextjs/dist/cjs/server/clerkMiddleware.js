...
const clerkMiddleware = ((...args) => {
  ...
  const middleware = import_middleware_storage.clerkMiddlewareRequestDataStorage.run(import_middleware_storage.clerkMiddlewareRequestDataStore, () => {
    const baseNextMiddleware = (0, import_debugLogger.withLogger)("clerkMiddleware", (logger) => async (request2, event2) => {
      ...
      const hasExplicitProxyOrDomain = resolvedParams.proxyUrl || import_constants.PROXY_URL || resolvedParams.domain || import_constants.DOMAIN;
      if (!frontendApiProxyConfig && !hasExplicitProxyOrDomain && !(0, import_proxy2.isAutoProxyDisabledFromEnvironment)() && (0, import_keys.isProductionFromPublishableKey)(publishableKey)) {
        if ((0, import_proxy2.shouldAutoProxy)(requestUrl.hostname)) {
